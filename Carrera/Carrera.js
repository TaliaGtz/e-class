...
//if(selCategory == "Categoría 1" || selCategory == "Categoría 2" || selCategory == "Categoría 3"){
    ...
    document.getElementById("datepkd").value = "2022-11-02";     //Limpia el DateTimePicker
...
btn.innerHTML = "<img src='../Extras/editar.png' id='editImg'/>";
...
btn2.innerHTML = "<img src='../Extras/delete.png' id='deleteImg'/>";
...
document.getElementById("idEditBtn" + IDedit).innerHTML = "<img src='../Extras/listo.png' id='doneImg'/>";
...
$("img[id=doneImg]").click(function() {
    ...
    $("div").click(function() {
        ...
        document.getElementById("idEditBtn" + IDedit).innerHTML = "<img src='../Extras/editar.png' id='editImg'/>";
